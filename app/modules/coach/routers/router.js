...
router.get('/coach/getdemandavailability', coachController.getDemandAvailability);
...
router.get('/coach/CoachCalendarAvaiabilityForUser', coachController.getallavailabilityforCoachDetail);
