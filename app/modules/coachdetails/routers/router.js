...
router.get(
  "/coachdetail/getbookcourse",
  coachDetailController.getCourseReservation
);
router.get("/coachdetail/getevent", coachDetailController.search_for_event);
router.get(
  "/coachdetail/geteventtop3",
  coachDetailController.search_for_event_top_3
);
router.get("/coachdetail/getallcourse", coachDetailController.getall_course);
router.get("/coachdetail/getallcourses", coachDetailController.getAllCourses);
router.post(
  "/coachdetail/getcoachbyevent",
  coachDetailController.getCoachbyevent
);
